...
function update() {
  ...
  const index = todoListContiner.findIndex(function (toList) {
    console.log(toList.id);
    if (toList.id === id) {
      toList.value = value;
    }
    return toList;
